...
def get_current_pos (filepath):
    ...
    df.to_csv('current_pos.csv', index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pos_statement_file', help='Optional: specify a file name in position_statement folder')
    parser.add_argument('--acc_statement_file', help='Optional: specify a file name in account_statement folder')
    args = parser.parse_args()

    # If pos_statement_file is not specified, get_latest_pos_statement will be executed to return the latest file
    if args.pos_statement_file:
        pos_statement_file = os.path.join('position_statement', args.pos_statement_file)
    else:
    ...
    if args.acc_statement_file:
        acc_statement_file = os.path.join('account_statement', args.acc_statement_file)
    else:
